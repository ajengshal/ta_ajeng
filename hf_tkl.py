...
MODBUS_IP = '10.6.30.178'
MODBUS_PORT = 502

# Device details
DEVICES = [
    {'address': 1, 'count': 2, 'slave_id': 7},
    {'address': 1, 'count': 2, 'slave_id': 8},
    {'address': 1, 'count': 2, 'slave_id': 9},
    {'address': 1, 'count': 2, 'slave_id': 10},
    {'address': 1, 'count': 2, 'slave_id': 11}
]
...
def insert_data_to_mysql(cursor, all_data):
    try:
        query = """
        INSERT INTO hf_tkl (timestamp, temp7, hum7, temp8, hum8, temp9, hum9, temp10, hum10, temp11, hum11)
